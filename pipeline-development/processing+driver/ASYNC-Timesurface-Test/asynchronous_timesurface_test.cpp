...
int main(void) {
    ...
    // remove existing recording files, if they exist
    if (filesystem::exists("asynchronous_timesurface_test__recent.raw"))
        filesystem::remove("asynchronous_timesurface_test__recent.raw");
    if (filesystem::exists("asynchronous_timesurface_test__recent.raw.tmp_index"))
        filesystem::remove("asynchronous_timesurface_test__recent.raw.tmp_index");
